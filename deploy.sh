...
scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -i "amazonkey-coronhackathon.pem" /home/travis/build/JulienB-Epfl/Coronhackathon/back/build/libs/backend-bis.jar ec2-user@ec2-23-20-204-191.compute-1.amazonaws.com:/home/ec2-user
